<?php
	 ...
	 */
	$aColumns = array( 'a.auto_seq','a.case_id','a.seq','a.engineering_date','a.floor','a.standard_manpower','a.available_manpower','a.manpower_gap','a.makeby','a.last_modify','a.seq2','c.actual_entry_date','a.actual_manpower','a.manpower_type','c.scheduled_entry_date','c.construction_days_per_floor','c.construction_days_first_floor','a.date_status','c.building','a.actual_works_per_floor');
